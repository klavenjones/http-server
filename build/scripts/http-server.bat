...
set CLASSPATH=%APP_HOME%\lib\http-server-1.0-SNAPSHOT.jar


@rem Execute http-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HTTP_SERVER_OPTS%  -classpath "%CLASSPATH%"  %*
...
if not ""=="%HTTP_SERVER_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
