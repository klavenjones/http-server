...
class RequestTest {
    ...
    @Test
    @DisplayName("Testing if Request returns the appropriate method value")
    public void testIfRequestObjectReturnCorrectMethodValue() {
        Request request =
                TestUtils.buildRequest(version, method, path, body, headers);
        assertEquals(request.method, "GET");
    }

    @Test
    @DisplayName("Testing if Request returns the appropriate version value")
    ...
    @Test
    @DisplayName("Testing if Request returns the appropriate path value")
    ...
    @Test
    @DisplayName("Testing if Request returns the appropriate body value")
    ...
    @Test
    @DisplayName("Testing if Request returns the appropriate headers value")
    ...
    @Test
    @DisplayName("Testing if Request will return the appropriate headers key")
